...
-- enable full dynamic partition mode

set hive.exec.dynamic.partition.mode=nonstrict;

insert overwrite table dest_table
partition (part_string_col, part_int_col)
select src.int_col, src.string_col, src.p_string_col, src.p_int_col from src_table src;
